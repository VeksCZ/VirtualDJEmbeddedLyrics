...
public:
    ...
    HRESULT VDJ_API OnDeviceClose() override { renderer_.Reset(); texture_.Reset(); device_ = nullptr; return S_OK; }
...
private:
    ...
    int VisibleVideoDeck() {
        ...
        if (FAILED(GetInfo("video_crossfader", &crossfader))) crossfader = 0.0;
